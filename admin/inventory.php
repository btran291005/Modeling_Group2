        ...
        <table class="table table-borderless table-hover align-middle mb-0">
            <thead>
                <tr style="border-bottom:1px solid rgba(255,255,255,.05);">
                    <th class="px-4 py-3" style="font-size:.75rem;font-weight:700;letter-spacing:.8px;text-transform:uppercase;color:rgba(13,202,240,.8);white-space:nowrap;">IMEI</th>
                    ...
                    <th class="py-3"      style="font-size:.75rem;font-weight:700;letter-spacing:.8px;text-transform:uppercase;color:rgba(13,202,240,.8);width:80px;">🔋 Pin</th>
                    <th class="py-3"      style="font-size:.75rem;font-weight:700;letter-spacing:.8px;text-transform:uppercase;color:rgba(13,202,240,.8);white-space:nowrap;">💰 Giá thu mua</th>
                    <th class="py-3"      style="font-size:.75rem;font-weight:700;letter-spacing:.8px;text-transform:uppercase;color:rgba(13,202,240,.8);">👤 Khách hàng</th>
                    ...
                    <th class="py-3"      style="font-size:.75rem;font-weight:700;letter-spacing:.8px;text-transform:uppercase;color:rgba(13,202,240,.8);white-space:nowrap;">📅 Ngày nhập</th>
                    <th class="py-3"      style="font-size:.75rem;font-weight:700;letter-spacing:.8px;text-transform:uppercase;color:rgba(13,202,240,.8);">Trạng thái</th>
                    <th class="px-4 py-3" style="font-size:.75rem;font-weight:700;letter-spacing:.8px;text-transform:uppercase;color:rgba(13,202,240,.8);width:90px;">Thao tác</th>
                </tr>
            </thead>
