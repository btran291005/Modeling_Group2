            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <button type="button" id="btn-add-brand" class="btn btn-info">Thêm Hãng</button>
                    </div>
                </div>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#modal-add-model">
                    ➕ Thêm Dòng máy
                </button>
            </div>
        ...
        <div class="modal-content">
            <form id="form-add-model">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-info">Thêm dòng máy</button>
                </div>
            </form>
        </div>
    </div>
